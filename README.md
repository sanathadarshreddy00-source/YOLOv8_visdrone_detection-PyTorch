...
- `configs/` — dataset & experiment YAMLs (visdrone.yaml, experiment_config.yaml, paths.yaml)
- `src/`
	- `data/` — dataset loaders and transforms
	- `utils/` — helper utilities
		- `paths.py` — loads `configs/paths.yaml` (central path resolver)
- `scripts/` — runnable pipeline scripts:
	- `01_convert_annotations.py`, `02_verify_data.py`, `03_prepare_dataset.py`,
		`04_train.py`, `05_evaluate.py`, `06_video_inference.py`
...
- `runs/detect/` — experiment outputs and demo videos
...
- `DEVELOPER_GUIDE.md`
- `MIGRATION_MANIFEST_20260224_154353.csv` (manifest of moved legacy runs)
